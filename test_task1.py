...
def test_task1():
    ...
    #task1D
    assert test1() == [950, 'River Dikler', 'River Glen', 'River Parrett', 'River Great Ouse', 'Smestow Brook', 'River Brock', 'River Wharfe', 'River Ouse', 'Letcombe Brook', 'Bradley Brook']
